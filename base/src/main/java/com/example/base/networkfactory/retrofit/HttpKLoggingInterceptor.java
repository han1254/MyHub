 ...
 */
public final class HttpKLoggingInterceptor implements Interceptor {
    ...
    public HttpKLoggingInterceptor() {
    }

    private volatile Level level = Level.NONE;

    /** Change the level at which this interceptor logs. */
    public HttpKLoggingInterceptor setLevel(Level level) {
